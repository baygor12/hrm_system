...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($employee) {
        ...
        $stored_hash = $stored_hash = '$2y$10$RwDnLmBOquORtcDRW9diJO2IZxgpEo3GT8qxwFGLmFbOoS7tbQK8q';
        ...
        $error_message = "Invalid login credentials."; // Display a message if the username is not found
    }
}
?>
